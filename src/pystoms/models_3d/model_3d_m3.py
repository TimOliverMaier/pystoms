...
class ModelM3(AbstractModel):
    ...
    Args:
        ...
        random_number_generator (np.random.Generator, optional): Random
            number generator for pymc sampling processes. Defaults to None.
    ...
    def __init__(
        ...
        # Model error
        self.me = pm.Exponential("me", lam=self.me_lambda, dims=dims_2d)
        # Likelihood
    ...
    def setup_mutable_data(
        ...
        self.me_lambda = pm.MutableData(
            "me_lambda", me_lambda, broadcastable=(True, False), dims=dims_2d
        )
    ...
    def _set_grid_data(self) -> None:
        ...
        me_lambda = data.me_lambda.isel(slice_2d).values.reshape(s_2d)
